  ...
  return (
    <div className="desktop-home-background pt-[2px]">
          ...
          <main className="text-white opacity-90 px-36 pt-64 pb-32 flex flex-row items-center justify-between">
            ...
            <div className="rounded-full w-[272px] h-[272px] bg-white text-blue-900 text-center font-bellefair font-normal text-[32px] uppercase flex items-center justify-center 
